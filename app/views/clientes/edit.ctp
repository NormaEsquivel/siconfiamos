...
echo $this->Form->create('Cliente', array(
	'url' => array('controller' => 'clientes', 'action' => 'edit'),
	'class' => 'block wizard'
));
?>
		...
		<fieldset class="wizard-fieldset fields-list">
			...
			<legend class="legend">Información Personal</legend>
				...
				<?php echo $this->Form->input('Aval.id'); ?>
				<?php echo $this->Form->input('Personal.id'); ?>
				<?php echo $this->Form->input('Familiar.id'); ?>
				<?php echo $this->Form->input('Ingreso.id'); ?>
