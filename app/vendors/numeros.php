...
for($xz = 0; $xz < 3; $xz++)
   ...
   while ($xexit)
      ...
      $xcadena = str_replace("DIEZ Y  UN", "ONCE", $xcadena);
	  $xcadena = str_replace("DIEZ Y  DOS", "DOCE", $xcadena);
      $xcadena = str_replace("DIEZ Y  TRES", "TRECE", $xcadena);
	  $xcadena = str_replace("DIEZ Y  CUATRO", "CATORCE", $xcadena);
	  $xcadena = str_replace("DIEZ Y  CINCO", "QUINCE", $xcadena);
	  $xcadena = str_replace("DIEZ Y  SEIS", "DIECISEIS", $xcadena);
	  $xcadena = str_replace("DIEZ Y  SIETE", "DIECISIETE", $xcadena);
	  $xcadena = str_replace("DIEZ Y  OCHO", "DIECIOCHO", $xcadena);
	  $xcadena = str_replace("DIEZ Y  NUEVE", "DIECINUEVE", $xcadena);
